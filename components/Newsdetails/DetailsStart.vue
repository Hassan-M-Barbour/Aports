                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="news-details__left">
                            <div class="news-details__img">
                                <img src="/Imags/news-details-img-1.jpg" alt="">
                            ...
                            <div class="comment-one">
                                ...
                                <div class="comment-one__single">
                                    <div class="comment-one__image">
                                        <img src="/Imags/comment-1-1.jpg" alt="">
                                    </div>
                                ...
                                <div class="comment-one__single">
                                    <div class="comment-one__image">
                                        <img src="/Imags/comment-1-2.jpg" alt="">
                                    </div>
                                    <div class="comment-one__content">
                                        <h3>Sarah albert</h3>
                                        <p>It has survived not only five centuries, but also the leap into electronic
                            ...
                            <div class="comment-form">
                                ...
                                <form action="/inc/sendemail.php" class="comment-one__form contact-form-validated"
                                    novalidate>
                                    <div class="row">
                                        <div class="col-xl-6">
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar__single sidebar__category">
                                ...
                                <ul class="sidebar__category-list list-unstyled">
                                    ...
                                    <li><a href="news-details.html">Sweet Home<span class="fa fa-arrow-right"></span></a>
                                    </li>
                                </ul>
                            </div>
