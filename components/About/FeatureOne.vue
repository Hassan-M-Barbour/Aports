      ...
      <div class="row">
          ...
          <div class="feature-four__single">
            <div class="feature-four__img-box">
              <div class="feature-four__img">
                <img src="/Imags/feature-four-1-1.jpg" alt="" />
              </div>
            </div>
            <div class="feature-four__content">
              <h3 class="feature-four__title">
                <a href="services.html">Living experience</a>
              </h3>
              <p class="feature-four__text">
                There are many variations of passages of available, but the
                majority have in some form, by humour words.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
          <div class="feature-four__single">
            <div class="feature-four__img-box">
              <div class="feature-four__img">
                <img src="/Imags/feature-four-1-2.jpg" alt="" />
              </div>
            </div>
            <div class="feature-four__content">
              <h3 class="feature-four__title">
        ...
        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
          <div class="feature-four__single">
            <div class="feature-four__img-box">
              <div class="feature-four__img">
                <img src="/Imags/feature-four-1-3.jpg" alt="" />
              </div>
            </div>
            <div class="feature-four__content">
              <h3 class="feature-four__title">
                <a href="services.html">Premium places</a>
              </h3>
              <p class="feature-four__text">
                There are many variations of passages of available, but the
                majority have in some form, by humour words.
