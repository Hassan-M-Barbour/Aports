      ...
      <div class="row">
          ...
          <div class="contact-one__left">
            ...
            <div class="contact-one__person">
              <div class="contact-one__person-img">
                <img src="/Imags/contact-one-person-img-1.jpg" alt="" />
              </div>
            ...
            <p class="contact-one__text-1">
              Lorem ipsum dolor sit amet, consecte adipiscing elit. In hac
              habitasse platea dictumst. Duis porta, quam ut finibus ultrices.
            </p>
        ...
        <div class="col-xl-8 col-lg-7">
          <div class="contact-one__right">
            <div class="row">
              <div class="contact-one__form-box px-5">
                <form
                  action="/inc/sendemail.php"
                  class="contact-one__form contact-one-validated"
                  ...
                  <div class="row">
                    <div class="col-xl-12">
                      ...
                      <div class="contact-one__btn-box">
                        <a href="about.html" class="thm-btn contact-one__btn"
                          >Send a Message</a
                        >
                      </div>
                    </div>
