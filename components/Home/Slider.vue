...
<template>
  <div class="relative">
    ...
    >
      <img :src="item" :class="[animationClass]" class="w-full vh-100 object-cover" draggable="false" />
    </UCarousel>


    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center pl-5 pt-5">
